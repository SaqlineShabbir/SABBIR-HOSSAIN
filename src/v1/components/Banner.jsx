...
const stats = [
  ...
  { num: 80, suffix: "+", label: "Projects Built" },
...
const StatItem = ({ num, suffix, label }) => {
  ...
  return (
    <div ref={ref}>
      <p className="gradient-text font-black text-2xl lg:text-3xl">{count}{suffix}</p>
...
const Banner = () => {
  ...
  const tick = () => {
    ...
    const updated  = isDeleting
      ...
      : fullText.substring(0, text.length + 1);
    setText(updated);
    if (isDeleting) setDelta(60);
    if (!isDeleting && updated === fullText) {
      setIsDeleting(true); setDelta(period);
    } else if (isDeleting && updated === "") {
      setIsDeleting(false); setLoopNum((n) => n + 1); setDelta(150);
    }
  };
    ...
    <section id="about" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto w-full px-5 lg:px-20 pt-24 pb-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="space-y-6 lg:w-[55%] text-center lg:text-left animate-fade-up">
            ...
            <p className="text-white/50 text-base lg:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              ...
              I combine clean code with great design to deliver digital experiences that users love.
            </p>

            <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-1">
              <a href="#contact" className="btn-primary"><FaEnvelope size={14} /> Hire Me</a>
              <a href="#projects" className="btn-outline">View Projects <HiArrowDown size={14} /></a>
            </div>
        ...
        <div className="mt-16 lg:mt-20">
          <p className="text-white/30 text-xs font-semibold uppercase tracking-[4px] text-center mb-6">Tech Stack</p>
        ...
        <div className="flex justify-center mt-14">
          <a href="#resume" className="flex flex-col items-center gap-2 text-white/25 hover:text-white/50 transition-colors duration-300">
